---
title: "Simulation and modeling technique Coursework SMT CW"
author: "Thusharkanth_20233168_2410213"
date: "2025-04-11"
output:
...
# --- RUN SIMULATIONS FOR  2 COUNTERS ---
```{r}
...
```
# --- VISUALIZATION OF COUNTER 1, 2 AND 3  ---
...
# --- CONCLUSION ---
cat("\n********** CONCLUSION **********\n")
if (results_counter_2$avg_actual_wait <= 15)  {
  cat(" 2 counters are ENOUGH.\n Avg wait time is acceptable.\n")
} else {
  cat(" 2 counters are NOT enough. Consider increasing.\n")
}
```
